...
public class matchServiceImpl implements matchService {
    ...
    public matchServiceImpl(matchRepo match_repo) {
        this.match_repo = match_repo;
    }

    // match history in our databases
    @Override
    public List<match> getAllMatches() {
        return this.match_repo.findAll();
    }
...
//                update the match in database
    ...
    private void updateMatchIndb(match match1) {
        match match = this.match_repo.findByTeamHeading(match1.getTeamHeading()).orElse(null);
    ...
    public List<List<String>> getPointTable() {
        ...
        String tableURL = "https://m.cricbuzz.com/cricket-series/7476/icc-mens-t20-world-cup-2024/points-table";
        try {
